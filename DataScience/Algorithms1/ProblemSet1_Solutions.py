...
def findCrossoverIndexHelper(x, y, left, right):
    ...
    #print(left, right)
    if x[left + 1] < y[left + 1]:
        #print("returning ", left)
        return left
    rec = findCrossoverIndexHelper(x, y, left + 1, right)
...
def integerCubeRootHelper(n, left, right):
    ...
    #print("integerCubeRootHelper", n, left, cube(left), right, cube(right))
...
#print("integerCubeRoot(1)", integerCubeRoot(1))
#print("integerCubeRoot(2)", integerCubeRoot(2))
#print("integerCubeRoot(4)", integerCubeRoot(4))
#print("integerCubeRoot(7)", integerCubeRoot(7))
#print("integerCubeRoot(8)", integerCubeRoot(8))
